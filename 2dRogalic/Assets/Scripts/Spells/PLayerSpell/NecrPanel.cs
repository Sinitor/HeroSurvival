...
using UnityEngine;
public class NecrPanel : MonoBehaviour
{
    public Vector3 vec;
    public Vector3 vec1;
    public Vector3 vec2;
    ...
    private void Update()
    {
        panel = GameObject.FindGameObjectsWithTag("LightingText");
        int limit = 3;
    ...
    {
        prefabs = new List<GameObject>(Resources.LoadAll<GameObject>("SpellsNecr"));
